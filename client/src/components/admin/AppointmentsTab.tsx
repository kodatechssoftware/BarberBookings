...
export const outsideHoursBlockTimeOptions = [
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="min-w-0">
                          ...
                          <p className="truncate text-xs text-gray-400">{appointment.customerPhone ? getAppointmentContactLinks(appointment.customerPhone).displayPhone : "Sem telem�vel"}</p>
                        </div>
                        <div className="min-w-0">
