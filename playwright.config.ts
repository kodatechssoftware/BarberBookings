...
export default defineConfig({
  ...
  webServer: {
    env: { MULTI_LOCATION_ENABLED: "false", DEMO_MODE: process.env.DEMO_MODE ?? "false", RESEND_API_KEY: "", RESEND_FROM_EMAIL: "", WHATSAPP_NOTIFICATIONS_ENABLED: "false", MESSAGING_PROVIDER: "none", META_WHATSAPP_WEBHOOK_ENABLED: "true", META_WHATSAPP_INBOUND_AUTO_REPLY_ENABLED: "true", META_WHATSAPP_WEBHOOK_VERIFY_TOKEN: "playwright-verify-token", META_WHATSAPP_APP_SECRET: "playwright-app-secret", META_WHATSAPP_WABA_ID: "playwright-waba", META_WHATSAPP_PHONE_NUMBER_ID: "playwright-phone" },
